# -*- coding: utf-8 -*-
set :application, "ShortCom"             # APPL-NAME  をアプリのプロジェクト名に設定
set :repository,  "git@git.drecom.jp:rookies/shortcom.git"    # GIT-REPOSITORY-URLに Gitサーバー上のリポジトリのURLを設定
set :server_ip, "192.168.141.152"                  # SERVER-IPにサーバーのIP アドレスを設定
